...
import { AddressCity } from '../../../domain/entities/address-entity/value-objects';
    ...
    ApplicationService<UpdateInstructorCommand, UpdateInstructorResponse>
{
  ...
  async execute(
    ...
    if (command.followers)
      instructor.updateFollowers(new InstructorFollowers(command.followers));
    if (command.userFollow)
      instructor.updateUserFollow(new InstructorUserFollow(command.userFollow));
