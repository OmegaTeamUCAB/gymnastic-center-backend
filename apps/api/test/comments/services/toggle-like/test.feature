Feature: Toggle Like
   ...
   Scenario: Toggle like button on a disliked comment
      Given the comment is created
      ...
      Then the like of the user with id "863a830b-3411-42df-8468-281e307086e9" should be added in the comment
