...
export class ValidateUser implements ApplicationService<ValidateUserDto, ValidateUserResponse> {
    constructor(
    ...
    public async execute(data: ValidateUserDto): Promise<Result<ValidateUserResponse>> {
        ...
        return Result.success<ValidateUserResponse>({ id: this.jwtService.generateToken(payload) });
    }
