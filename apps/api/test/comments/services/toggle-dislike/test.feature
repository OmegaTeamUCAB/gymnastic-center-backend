Feature: Toggle Dislike

  Rule: If the user toggle the dislike button on a disliked comment, the like should be removed from the comment, otherwise the dislike is added
    ...
    Scenario: Toggle dislike button on a liked comment
      Given the comment is created
      ...
      But the dislike of the user with id "863a830b-3411-42df-8468-281e307086e9" should be added in the comment
